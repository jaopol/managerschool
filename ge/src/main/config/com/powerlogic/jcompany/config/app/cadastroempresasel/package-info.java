...
@PlcConfigGrupoControle(
	...
	selecao = @PlcConfigSelecao(
				navegador = @PlcConfigNavegador(numPorPagina=20, dinamicoTipo=com.powerlogic.jcompany.config.controle.colaboracao.PlcConfigNavegador.DinamicoTipo.DINAMICO_PAGINA),				argumentos = {
						@PlcConfigArgumento(propriedade="nomeEmpresa", operador=Operador.LIKE_PERC_FINAL, formato=Formato.STRING),
						@PlcConfigArgumento(propriedade="dataCadastro", operador=Operador.IGUAL_A, formato=Formato.DATE)
			})

)
	
//Gerado em 19/03/2015 20:36 por jCompany Code Generator
package com.powerlogic.jcompany.config.app.cadastroempresasel;
