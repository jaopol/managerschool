...
jQuery(function(){
	...
	var googleMapsKey = window.googleMapsKey || '#{googleMapsKey}';
	...
	if (mapa) {
		...
		html += '<iframe src="'+ plcGeral.contextPath +'/plc/javascript-w2/un/googlemaps.html?googleMapsKey='+ googleMapsKey +'" width="'+ width +'" height="'+ height +'" style="display: block"></iframe>';
