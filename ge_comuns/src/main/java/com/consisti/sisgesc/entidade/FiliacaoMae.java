...
public abstract class FiliacaoMae extends AppBaseEntity {
	
	@Id @GeneratedValue(strategy=GenerationType.AUTO, generator = "SE_FILIACAO_MAE")
	@Column (name = "ID_FILIACAO_MAE", nullable=false, length=5)
	private Long id;
