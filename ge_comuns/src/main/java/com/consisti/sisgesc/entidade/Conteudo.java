...
public abstract class Conteudo extends AppBaseEntity {

	@Id @GeneratedValue(strategy=GenerationType.AUTO, generator = "SE_CONTEUDO")
	@Column (name = "ID_CONTEUDO", nullable=false, length=5)
	private Long id;
