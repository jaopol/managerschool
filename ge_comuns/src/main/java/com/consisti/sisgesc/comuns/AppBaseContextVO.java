...
public class AppBaseContextVO extends PlcBaseContextVO {
	...
	private boolean apresentaMensagem;
	...
	public boolean isApresentaMensagem() {
		return apresentaMensagem;
	}

	public void setApresentaMensagem(boolean apresentaMensagem) {
		this.apresentaMensagem = apresentaMensagem;
	}
